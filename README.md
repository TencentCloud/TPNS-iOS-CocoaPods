...
VERSION 1.4.0.8
-------------------------------------------
1.Optimization: Optimize of Lifecycle Business Logic.
2.Fix: Fixed known issues.

版本 1.4.0.7
-------------------------------------------
1.新增：实时活动远程启动支持二级标签分类。

VERSION 1.4.0.7
-------------------------------------------
1.New: LiveActivity remote start supports two-level tag categorization.
...
VERSION 1.4.0.6
-------------------------------------------
1. New: LiveActivity support remote start.
