Pod::Spec.new do |spec|
  ...
  spec.source              = { :git => 'https://github.com/TencentCloud/TPNS-iOS-CocoaPods.git', :branch => 'V1.4.0.3' }
  ...
  spec.resource_bundle     = {'TPNS-iOS-Privacy' => 'XGVIPPush/PrivacyInfo.xcprivacy'}
end